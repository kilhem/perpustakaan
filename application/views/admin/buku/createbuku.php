      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Form Data Buku</h4>
            <p class="card-category">Masukkan Data Buku</p>
          </div>
          <div class="card-body">
            <h4>Data Buku</h4>
            <hr>
            <form action="<?php echo base_url() . 'tambahdatabuku'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating">Id Buku<small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="isbn" value="BKU-<?= $id_buku ?>" class="form-control" readonly>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="judul" class="form-control" value="<?= set_value('judul') ?>">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="penerbit" class="form-control">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="tahunterbit" class="form-control" value="<?= set_value('tahunterbit') ?>">
                    <?= form_error('tahunterbit', '<small class="text-danger">', '</small>'); ?>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating">Stok Buku<small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="stok" class="form-control" value="<?= set_value('stok') ?>">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="hidden" class="form-control" id="id_kategori" name="kategoribuku" placeholder="Nomor Id Kategori" readonly>
                          <input type="text" class="form-control" id="nama_kategori" name="namakategori" readonly>
                        ...
                        <!-- 
                            <select class="form-control" name="kategoribuku" style="padding:10px;height: 45px;">
